...
def process_image(rgb_img):
    ...
    if(adjust_init==1):
        ...
        enhanced = clahe.apply(blurred)
         # 二值化处理
        thresh = 250
        _, binary_img = cv2.threshold(enhanced, thresh, 255, cv2.THRESH_BINARY)
    ...
    #cv2.imwrite(r'C:/Users/Administrator/Desktop/1111' + f"\\bin_{get_time_str()}.png",
    #             binary_img_3c)
...
#        cv2.imread(r'D:\Resources\Projects\Python\ultralytics-main-2\val\png\[raw]20240731220254176706.png'))
